...
def calculate_stripline():
    ...
    z0_calc = (60.0 / sqrt(args.eps_r)) * log((1.9 * total_height) / denominator)
    ...
    line = DefinedGammaZ0(frequency=rf.Frequency(args.freq, args.freq, 1, "GHz"), z0=z0_calc, gamma=gamma)
